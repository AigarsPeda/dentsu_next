        ...
        {articles.map((article) => {
          ...
          return (
            <Link
              ...
              key={article.id}
              className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-900 lg:w-[300px] xl:min-w-[375px] rounded-lg overflow-hidden shadow-lg"
            >
              {imageUrl && (
                <img
                  src={imageUrl}
